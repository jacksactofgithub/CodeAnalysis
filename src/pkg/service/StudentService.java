...
public class StudentService {
	...
	public JSONArray getExams(String stu_account){
		try {
			return new JSONArray("[{'id':382,'exam_name':'第一次上机考试','teacher_name':'刘钦','exam_begin_time':'2016-4-9 8:00:01',"
					+ "'exam_end_time':'2016-4-9 10:00:01','exam_duration':120,'score':87},{'id':2,'exam_name':'测试考试2','teacher_name':'陈振宇','exam_begin_time':'2016-4-1 14:00:01',"
