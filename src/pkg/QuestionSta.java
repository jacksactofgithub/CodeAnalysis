...
/**
 * Servlet implementation class TestMatch
 */
@WebServlet("/questionSta")
public class QuestionSta extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		context.getRequestDispatcher("/view/questionSta.jsp").forward(request, response);
	}
